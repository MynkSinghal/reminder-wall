...
// Quotes now live in lib/quotes.ts + Redis (managed from the dashboard).
...
const FACE_PX  = 380;
const FACE_GAP = 56;
// Custom portraits (dashboard uploads) live in Redis as data URIs.
// Built-in portraits are PNGs in public/portraits/<slug>.png.
